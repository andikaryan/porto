...
export default function Stack() {
  ...
  const techStacks: TechStackItem[] = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-green-600 dark:text-green-400">
    ...
    },
    {
      name: "UI/UX Design",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-purple-600 dark:text-purple-400">
  ...
  return (
    <section className="py-20 px-4 bg-gray-50 dark:bg-gray-800" id="stack">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-center text-blue-600 dark:text-blue-400">Tech Stack</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">          {techStacks.map((stack) => (
            <div 
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{stack.name}</h3>
              <p className="text-gray-700 dark:text-gray-300">{stack.description}</p>
            </div>
          ))}
        </div>
        ...
        {/* Technologies List */}
        <div className="mt-16">
          <h3 className="text-xl font-bold mb-6 text-center text-gray-800 dark:text-gray-200">Technologies I Work With</h3>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <span 
                key={tech}
                className="px-4 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-md shadow-sm border border-gray-200 dark:border-gray-700"
              >
                {tech}
              </span>
            ))}
