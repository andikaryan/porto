...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-blue-900 to-gray-900 pt-24" id="hero">
      ...
      <a href="https://drive.google.com/file/d/1RzuVwiisWmgnvPn4pByF52ivikKN2Z4B/view?usp=sharing" className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition">Lihat Resume</a>
    </section>
  );
}
